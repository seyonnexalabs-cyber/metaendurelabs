...
export default function AboutPage() {
  ...
  return (
    <div className="space-y-24 py-12 px-6 md:px-12 max-w-[1400px] mx-auto">
      ...
      <section id="philosophy" className="bg-gradient-to-r from-[#0a180e] via-[#122818] to-[#0a180e] border border-[#76C043]/30 rounded-3xl p-8 md:p-12 text-center max-w-4xl mx-auto space-y-4 scroll-mt-24">
        <span className="text-xs font-mono text-[#76C043] uppercase tracking-widest font-bold">The Core Realization</span>
        <h2 className="font-heading text-2xl md:text-3xl font-extrabold text-white">
          Why METAENDURE LABS?
        </h2>
        <p className="text-lg md:text-xl font-heading font-semibold text-[#76C043] italic max-w-2xl mx-auto">
          "Most people do not fail because they lack potential. They fail because they lack a proven system."
        </p>
        <p className="text-xs md:text-sm text-[#bdcebe] leading-relaxed max-w-2xl mx-auto">
      ...
      <section id="pillars" className="space-y-8 scroll-mt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-card p-6 space-y-4 group hover:border-[#76C043]/60 transition-all">
            <div className="w-20 h-20 rounded-2xl overflow-hidden border border-white/10 shadow-[0_8px_25px_rgba(0,0,0,0.5)] group-hover:scale-105 transition-transform">
              <img
            ...
            <div className="font-mono text-sm font-bold text-[#76C043]">Pillar 01</div>
          ...
          <div className="glass-card p-6 space-y-4 border-[#76C043]/40 group hover:shadow-[0_0_25px_rgba(118,192,67,0.2)] transition-all">
            <div className="w-20 h-20 rounded-2xl overflow-hidden border border-white/10 shadow-[0_8px_25px_rgba(0,0,0,0.5)] group-hover:scale-105 transition-transform">
              <img
            ...
            <div className="font-mono text-sm font-bold text-[#76C043]">Pillar 02</div>
          ...
          <div className="glass-card p-6 space-y-4 group hover:border-[#76C043]/60 transition-all">
            ...
            <div className="font-mono text-sm font-bold text-[#76C043]">Pillar 03</div>
      ...
      <section id="system" className="glass-card p-8 md:p-12 space-y-8 scroll-mt-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
          {[
            { step: '01', name: 'ASSESS', desc: 'Understand current fitness, habits, lifestyle, and goals.' },
            { step: '02', name: 'PLAN', desc: 'Build a science-backed roadmap tailored to the individual.' },
            { step: '03', name: 'EXECUTE', desc: 'Apply structured training, nutrition, and recovery.' },
            { step: '04', name: 'ADAPT', desc: 'Review performance data and refine the plan continuously.' },
            { step: '05', name: 'ACHIEVE', desc: 'Deliver measurable improvements and results.' },
            { step: '06', name: 'EVOLVE', desc: 'Create lifelong habits that drive continuous growth.' },
          ].map((s) => (
            <div key={s.step} className="bg-[#08120b] border border-white/10 rounded-xl p-4 text-center">
              ...
              <p className="text-[11px] text-[#788e7a]">{s.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="different" className="space-y-8 scroll-mt-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {differentiators.map((d) => (
            <div key={d.num} className="glass-card p-5 text-center">
              <div className="font-mono text-xl font-bold text-[#76C043] mb-2">{d.num}</div>
